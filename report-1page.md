...
## Phân công thực hiện
Nguyễn Gia Huân: Phụ trách phát triển sender.py, thiết kế cấu trúc Header 20-byte, xây dựng logic mã hóa trong des_socket_utils.py và soạn thảo threat-model-1page.md.
Vũ Đức Sơn : Phụ trách phát triển receiver.py, xử lý hàm đọc dữ liệu chính xác recv_exact, thực hiện toàn bộ các ca kiểm thử tự động (pytest) và quản lý hệ thống logs.
